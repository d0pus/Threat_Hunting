...
2. Загрузка и установка интерпретатора R.

![](img/2.png)

3. Создание публичного репозитория на GitHub.

![](img/3.png)

4. Создание файла README.md и README.qmd - отчета, включая фрагменты кода, ex:
```{r}
print('Hello, Grisha!')
```
...
В ходе выполнения практической работы мною был подготовлен отчет на GitHub. Использовался язык Markdown.

## Вывод

Были получены навыки по формированию отчетов лабораторных работ и работе в RStudio.