...
1. Установить программный пакет swirl: функцией R install.packages("swirl"). Также все недостающие пакеты.
...
В ходе выполнения практической работы была установлена библиотека swirl, пройдены 5 тем из курса "R Programming: The basics of programming in R".
 
## Вывод 

Так, мною была изучена база языка R: Basic Building Blocks, Workspace and Files, Sequences of Numbers, Vectors, Missing Values.
```{r}
